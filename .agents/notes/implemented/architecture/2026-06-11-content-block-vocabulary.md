...
English | [中文](https://github.com/deepseek-ai/deepseek-harness/blob/master/.agents/notes/implemented/architecture/2026-06-11-content-block-vocabulary.zh.md)
...
- Multimodal blocks return only with coordinated adapter, UI, and compaction support; see [the drop-image Agent Note](https://github.com/deepseek-ai/deepseek-harness/blob/master/.agents/notes/implemented/simplification/2026-07-04-drop-image-content-block.md).
- Cache hints and assistant prefill remain absent until a shipping adapter can honor them; see the [producer-less variants](https://github.com/deepseek-ai/deepseek-harness/blob/master/.agents/notes/archived/simplification/2026-07-04-prune-producerless-vocabulary-variants.md) and [inert request knobs](https://github.com/deepseek-ai/deepseek-harness/blob/master/.agents/notes/archived/simplification/2026-07-04-drop-inert-request-knobs.md) Agent Notes.
