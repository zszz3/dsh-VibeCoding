...
English | [中文](https://github.com/deepseek-ai/deepseek-harness/blob/master/.agents/notes/implemented/feature/2026-08-06-web-queue-steer-all-gesture.zh.md)
...
The per-row 插话发送 action and its strict-steer boundary are owned by [Steer a queued Web message into the active turn](https://github.com/deepseek-ai/deepseek-harness/blob/master/.agents/notes/implemented/feature/2026-07-30-web-queue-steer-action.md); this note only adds the whole-queue keyboard gesture on top of that decision.
