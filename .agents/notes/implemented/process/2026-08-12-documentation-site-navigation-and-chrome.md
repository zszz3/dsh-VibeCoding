...
English | [中文](https://github.com/deepseek-ai/deepseek-harness/blob/master/.agents/notes/implemented/process/2026-08-12-documentation-site-navigation-and-chrome.zh.md)
...
`projectedPageContent` in [scripts/project-doc-site.ts](https://github.com/deepseek-ai/deepseek-harness/blob/master/scripts/project-doc-site.ts) drops the language-switcher line and the repository badge. The switcher match is confined to the first eight lines so a tutorial that shows the convention still renders its example.
