...
English | [中文](https://github.com/deepseek-ai/deepseek-harness/blob/master/.agents/notes/implemented/process/2026-08-10-vendor-package-rescope.zh.md)
...
All nine packages move into the `@deepseek-ai` scope. Directory names, upstream version numbers, and dependency ranges stay untouched, so the `vendor/README.md` manifest still reads as an upstream snapshot. [docs/rescope.md](https://github.com/deepseek-ai/deepseek-harness/blob/master/docs/rescope.md) restates this mapping for consumers.
