...
English | [中文](https://github.com/deepseek-ai/deepseek-harness/blob/master/.agents/notes/rejected/simplification/2026-06-20-drop-durable-step-boundaries.zh.md)
...
- The [event taxonomy docs](https://github.com/deepseek-ai/deepseek-harness/blob/master/docs/architecture.md) describe turns as the durable boundary and steps as a field on step-scoped records.
