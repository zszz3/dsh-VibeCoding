...
English | [中文](https://github.com/deepseek-ai/deepseek-harness/blob/master/.agents/notes/archived/process/2026-06-20-generated-cordis-catalog.zh.md)
...
This is the wiring-axis complement to the [core-data-structures catalog](https://github.com/deepseek-ai/deepseek-harness/blob/master/docs/core-data-structures/core.md) ([its Agent Note](https://github.com/deepseek-ai/deepseek-harness/blob/master/.agents/notes/archived/process/2026-06-20-core-data-structures-catalog.md)): that one catalogs the *data structures* the loop moves around (verified hand-pastes); this one catalogs the *events and services* that move them.
