...
- For an edited bilingual source, follow the lightweight routine path in [docs/AGENTS.md](../../../docs/AGENTS.md#writing-rules) and the [pairing contract](https://github.com/deepseek-ai/deepseek-harness/blob/master/docs/i18n/README.md); never invoke the extended translation skill automatically.
