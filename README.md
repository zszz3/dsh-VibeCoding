...
| [五、Skills](guide/05-skills.md) | 值钱的不是把步骤记下来,而是固化那条「AI 容易做错、且做错了当时看不出来」的判断。共同形状是「一条可执行的判定 + 一张防止做过头的护栏」,而护栏那半通常更难写。另附[八类思维链泄漏的对照表](guide/05-skills-appendix.md),备查。 |
